...
SCORE = 0
COINS = 0
COINS_FOR_SPEEDUP = 5  # every 5 coins increase speed
FPS = 60
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = coin_img
        self.rect = self.image.get_rect()
        self.weight = random.choice([1, 2, 3])  # Random coin weight
    ...
    def move(self):
        ...
        if self.rect.colliderect(P1.rect):
            ...
            # Increase speed by coin collection
...
# speed increase static
timer_speed_increase = 5000  # Decreased passive speed increase interval
INC_SPEED = pygame.USEREVENT + 1
pygame.time.set_timer(INC_SPEED, timer_speed_increase)
